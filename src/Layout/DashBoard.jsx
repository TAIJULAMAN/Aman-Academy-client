...
import { FaBook, FaBookOpen, FaCalendarAlt, FaHome, FaShoppingBasket, FaShoppingCart, FaUsers, FaUtensils, FaWallet } from "react-icons/fa";
...
const DashBoard = () => {
    ...
    return (
        <div className="drawer lg:drawer-open">
               ...
               <div className="drawer-side bg-slate-800 text-orange-600">
